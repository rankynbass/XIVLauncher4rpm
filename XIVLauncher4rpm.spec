...
Source1:        https://github.com/rankynbass/XIVLauncher4rpm
...
%setup -n FFXIVQuickLauncher
# Now unpack the extra files from this repo into a folder
%setup -n XIVLauncher4rpm



%build
mkdir -p %{launcher}
cd %{_builddir}/FFXIVQuickLauncher/
...
cd %{buildroot}
ln -sr "opt/XIVLauncher/xivlauncher" "usr/bin/xivlauncher"
...
/opt/XIVLauncher/opensslfix.cnf
/opt/XIVLauncher/xivlauncher
