...
then
    ...
    cp cleanupprofile.sh openssl_fix.cnf xivlauncher.sh XIVLauncher.desktop XIVLauncher-git-custom.desktop COPYING "$workingdir/XIVLauncher4rpm-$DownstreamTag-git/"
    cd "$workingdir" || exit
